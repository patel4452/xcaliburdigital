...
class Team {
    ...
    public function __construct() {
        ...
        $this->name = __( 'Team', 'inpulse-core' );
        $this->singular_name = __( 'Member', 'inpulse-core' );
        $this->plural_name = __( 'Members', 'inpulse-core' );

        $this->slug = InPulse_Theme_Helper::get_option('team_slug') != '' ? InPulse_Theme_Helper::get_option('team_slug') : 'team';
...
function render_wgl_team ($atts) {
    ...
    list($query_args) = InPulse_Loop_Settings::buildQuery($item_atts);
