			...
			<?php if( $style == 'style_1' ) : ?>
						...
						<div class="image">
							<?php if ( $link['url'] ): ?>
								<a href="<?php echo esc_url( $link['url'] ); ?>">
                                    <?php echo consulting_filtered_output($author_photo['thumbnail']); ?>
                                </a>
							<?php else: ?>
								<?php echo consulting_filtered_output($author_photo['thumbnail']); ?>
							<?php endif; ?>
				...
				<?php else: ?>
					<div class="testimonial">
						...
						<div class="image">
							<?php if ( $link['url'] ): ?>
								<a href="<?php echo esc_url( $link['url'] ); ?>"><?php echo consulting_filtered_output($author_photo['thumbnail']); ?></a>
							<?php else: ?>
								<?php echo consulting_filtered_output($author_photo['thumbnail']); ?>
							<?php endif; ?>
						</div>
