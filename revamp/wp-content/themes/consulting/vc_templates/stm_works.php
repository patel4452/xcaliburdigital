    ...
    <?php else: ?>
        <div id="<?php echo esc_attr($works_id); ?>" class="stm_works_wr<?php echo esc_attr($css_class); ?>">
                        ...
                        <div class="item all<?php echo esc_attr($work_class); ?>">
                            <?php if ($grid_with_filter_style == 'style_2') : ?>
                                ...
                                <div class="item_wr">
                                    ...
                                    echo consulting_filtered_output($post_thumbnail['thumbnail']);
                            ...
                            <?php else: ?>
                                ...
                                <div class="image">
                                    ...
                                    ?>
                                    <a href="<?php the_permalink(); ?>"><?php echo consulting_filtered_output($post_thumbnail['thumbnail']); ?></a>
                                </div>
                                <div class="info">
                                    <?php if ($term_list): ?>
                                        <div class="category"><a
            ...
            <?php elseif ($style == 'grid' && $grid_style == 'style_2'): ?>
                        ...
                        while ($all_works->have_posts()): $all_works->the_post();
                            ...
                            <div class="item">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    ?>
                                    <?php echo consulting_filtered_output($post_thumbnail['thumbnail']); ?>
                                </a>
                ...
                <?php elseif (stm_check_layout('layout_19') || stm_check_layout('layout_zurich') || stm_check_layout('layout_san_francisco')): ?>
