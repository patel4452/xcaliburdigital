            ...
            <?php foreach ($demos as $demo_key => $demo_value): ?>
                ...
                <label class="<?php if ($demo_key == $current_demo) echo 'active'; ?>">
                    <div class="inner">
                        ...
                        <?php else: ?>
                            <div class="install"
                                 data-name="<?php echo esc_attr($demo_value['label']); ?>" data-layout="<?php echo esc_attr($demo_key); ?>"><?php esc_html_e('Import', 'consulting'); ?></div>
                        <?php endif; ?>
        ...
        <div class="stm_install__demo_popup">
            ...
            <div class="inner">
                ...
                <div class="privacy_policy">
                    ...
                    <div class="privacy_policy_button decline" data-value="decline"><?php esc_html_e('Decline', 'consulting'); ?></div>
                    <div class="privacy_policy_button" data-value="accept"><?php esc_html_e('Accept', 'consulting'); ?></div>
