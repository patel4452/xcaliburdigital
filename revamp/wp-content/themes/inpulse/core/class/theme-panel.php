    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            add_menu_page (
                esc_html__('WebGeniusLab', 'inpulse'),
                esc_html__('WebGeniusLab', 'inpulse'), 
            ...
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'inpulse'),    //page_title
                esc_html__('Welcome', 'inpulse'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'inpulse'),   //page_title
                    esc_html__('Theme Plugins', 'inpulse'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'inpulse'),   //page_title
                esc_html__('Requirements', 'inpulse'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'inpulse'),   //page_title
                esc_html__('Activate Theme', 'inpulse'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'inpulse'),   //page_title
                esc_html__('Help Center', 'inpulse'),   //menu_title
                'edit_posts',                           //capability
            ...
            if ( class_exists( 'InPulse_Core' ) ) {
                $submenu[] = array(
                    esc_html__('Theme Options', 'inpulse'),   //page_title
                    esc_html__('Theme Options', 'inpulse'),   //menu_title
                    'edit_posts',                           //capability
