<?php
	...
	$show_share = InPulse_Theme_Helper::get_option('single_share');
	$show_views = InPulse_Theme_Helper::get_option('single_views');
	$show_tags = InPulse_Theme_Helper::get_option('single_meta_tags');
	$single_author_info = InPulse_Theme_Helper::get_option('single_author_info');
	$single_meta = InPulse_Theme_Helper::get_option('single_meta');
	$single_cats = InPulse_Theme_Helper::get_option('single_meta_categories');
		...
		<div class="item_wrapper">
			<div class="blog-post_content">
				...
				<?php					
					...
					wp_link_pages(array('before' => '<div class="page-link"><span class="pagger_info_text">' . esc_html__('Pages', 'inpulse') . ': </span>', 'after' => '</div>'));
