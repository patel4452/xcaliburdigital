...
<?php if( $box_style == 'style_1' ) : ?>
	...
	<?php if( $style == 'icon_left' ){ ?>
        ...
        <?php endif; ?>
            <?php if( $icon ){ ?>
                <div class="icon <?php echo esc_attr($icon_class); ?>" <?php echo sanitize_text_field($icon_style);  ?>><i style="font-size:<?php echo esc_attr( $icon_size ); ?>px; <?php if( $icon_color_custom ){ ?>color: <?php echo esc_attr( $icon_color_custom );?>;<?php } ?> <?php if( $icon_bg_color_custom ){ ?>background-color: <?php echo esc_attr( $icon_bg_color_custom );?>;<?php } ?>" class="<?php echo esc_attr( $icon ); ?>"></i></div>
            <?php } ?>
            <div class="icon_text">
                <?php if ( $title ) { ?>
...
<?php elseif( $box_style == 'style_2' ) : ?>
    ...
    <?php endif; ?>
		<div class="icon_box_inner">
			<?php if( $icon ){ ?>
				<div class="icon <?php echo esc_attr($icon_class); ?>" <?php echo sanitize_text_field($icon_style);  ?>><i style="font-size:<?php echo esc_attr( $icon_size ); ?>px; <?php if( $icon_color_custom ){ ?>color: <?php echo esc_attr( $icon_color_custom );?>;<?php } ?>" class="<?php echo esc_attr( $icon ); ?>"></i></div>
			<?php } ?>
			<?php if ( $title ) { ?>
				<h5 <?php echo sanitize_text_field($title_style); ?> <?php echo sanitize_text_field($title_class); ?>><?php echo wp_kses( $title, array( 'br' => array() ) ); ?></h5>
			<?php } ?>
...
<?php elseif( $box_style == 'style_3' ) : ?>
    ...
    <div class="icon_box_inner">
        <?php if( $icon ){ ?>
            <div class="icon <?php echo esc_attr($icon_class); ?>"<?php echo sanitize_text_field($icon_style);  ?>><i style="font-size:<?php echo esc_attr( $icon_size ); ?>px; <?php if( $icon_color_custom ){ ?>color: <?php echo esc_attr( $icon_color_custom );?>;<?php } ?> <?php if( $icon_line_height ){ ?>line-height: <?php echo esc_attr( $icon_line_height ); ?>px;<?php } ?> <?php if( $icon_border_color_custom ){ ?>border-color: <?php echo esc_attr( $icon_border_color_custom );?><?php } ?>" class="<?php echo esc_attr( $icon ); ?>"></i></div>
        <?php } ?>
        <?php if ( $content ) { ?>
            <div class="icon_text">
                <?php echo wpb_js_remove_wpautop( $content, true ); ?>
        ...
        <div class="icon_box_inner">
            <?php if( $icon ){ ?>
                <div class="icon <?php echo esc_attr($icon_class); ?>" <?php echo sanitize_text_field($icon_style);  ?>>
                    ...
                    <i style="font-size:<?php echo esc_attr( $icon_size ); ?>px; <?php if( $icon_color_custom ){ ?>color: <?php echo esc_attr( $icon_color_custom );?>;<?php } ?> <?php if( $icon_line_height ){ ?>line-height: <?php echo esc_attr( $icon_line_height ); ?>px;<?php } ?> <?php if( $icon_border_color_custom ){ ?>border-color: <?php echo esc_attr( $icon_border_color_custom );?><?php } ?>" class="<?php echo esc_attr( $icon ); ?>"></i>
                </div>
            <?php } ?>
            <?php if ( $title ) { ?>
                <h4 <?php echo sanitize_text_field($title_style); ?> <?php echo sanitize_text_field($title_class); ?>><?php echo wp_kses( $title, array( 'br' => array() ) ); ?></h4>
