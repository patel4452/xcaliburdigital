        ...
        <div class="event-members-box-table-row text-right">
            ...
            <?php if (!empty($stm_event_date_start) and !empty($stm_event_date_end)) : ?>
                <div class="addtocalendar">
                    <var class="atc_event">
                        <var class="atc_date_start"><?php echo sanitize_text_field($event_year_start); ?>-<?php echo sanitize_text_field($event_month_start); ?>
                            -<?php echo sanitize_text_field($event_day_start); ?> <?php echo esc_html($stm_event_time_start); ?></var>
                        <var class="atc_date_end"><?php echo sanitize_text_field($event_year_end); ?>-<?php echo sanitize_text_field($event_month_end); ?>
                            -<?php echo sanitize_text_field($event_day_end); ?> <?php echo esc_html($stm_event_time_end); ?></var>
