...
define('WP_HOME','https://xcaliburdigital.com');
define('WP_SITEURL','https://xcaliburdigital.com');
...
define('DB_NAME', 'xcaliburdigital');

/** MySQL database username */
define('DB_USER', 'xcaliburdigital');

/** MySQL database password */
define('DB_PASSWORD', 'Xcalibur3434@');
